...
class SetupPageLocators(object):
    ...
    INTEGRATION_SEND_INSTRUCTION_FORM_INPUT = (By.XPATH, '//label[contains(string(), "Installation")]/..//input')
    INTEGRATION_SEND_INSTRUCTION_FORM_ERROR_MASSAGE = (By.XPATH, '//label[contains(string(), "Installation")]/..//span[2]')
